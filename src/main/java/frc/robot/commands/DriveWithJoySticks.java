...
public class DriveWithJoySticks extends CommandBase {
    ...
    private DoubleSupplier m_myTurn;
    ...
    public DriveWithJoySticks(DoubleSupplier mySpeed, DoubleSupplier myTurn, DriveTrain subsystem) {
    ...
    public void execute() {
        ...
        double zRotation = m_myTurn.getAsDouble();
